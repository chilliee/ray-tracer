...
struct Spectrum {
    ...
    Spectrum() { r = g = b = 0.f; }
    explicit Spectrum(float _r, float _g, float _b) : r(_r), g(_g), b(_b) {};
    ...
    Spectrum operator+=(Spectrum v) { r += v.r; g += v.g; b += v.b; return *this; }
    Spectrum operator*=(Spectrum v) { r *= v.r; g *= v.g; b *= v.b; return *this; }
    ...
    static Spectrum direction(Vec3f v) {
        v.normalize();
    ...
    Vec3f to_vec() const { return Vec3f(r, g, b); }
